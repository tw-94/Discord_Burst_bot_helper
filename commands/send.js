module.exports = {
    ...
    execute(message, args) {
        ...
        if(message.member.roles.some(r=>["Helpful miner"].includes(r.name))) {
            var Url = `https://burst-wallet.daprogs.com/burst?requestType=sendMoney&secretPhrase=${burst_key}&recipient=${args[0]}&amountNQT=20000000&feeNQT=2500000&deadline=1440`
            request({
             url:Url,
             method:"POST",
